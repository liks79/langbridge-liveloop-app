...
**LangBridge**는 AI(Gemini)를 활용하여 영어 학습을 더 스마트하고 즐겁게 만들어주는 모던 웹 애플리케이션입니다. 분석, 퀴즈, 다이얼로그 생성 등 다양한 학습 기능을 통해 네이티브 수준의 영어를 경험하세요.
...
>
> 🏠 **DEMO SITE**: https://langbridge.liveloop.app/ (AI API 스로틀링 발생으로 사용이 원할하지 않을 수 있습니다. DEMO 페이지는 상황에 따라 close 할수도 있습니다.)
...
* [Cloudflare Dashboard Variables(환경 변수 적용) 문서](https://developers.cloudflare.com/workers/configuration/environment-variables/)
...
- **Zero Trust**: 필요한 경우 Cloudflare Access를 연동하여 접근 제어를 통해 사이트 전체를 보호할 수 있습니다.
